...
To facilitate more data, I'll create a new variable with cleaner premises and specify the old one PremiseDetailed. I'll also create a column called PremiseCategory that is RESIDENTIAL, BUSINESS, GOVERNMENT, INDUSTRIAL, PARK, TRANSPORT, PUBLICSERVICE, NIGHTLIFE, STREET, VACANT
```{r premises detail}
...
premise <- replaceWith(premise, "BLDG UNDER", "CONSTRUCTION")
